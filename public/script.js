document.addEventListener('DOMContentLoaded', function () {
  ...
  (function applyRTLSupport() {
    ...
    if (isRTL) {
      ...
      const scrollToTopBtns = document.querySelectorAll('.scroll-to-top, [data-scroll-top]');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "wellness clinic משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'abad51aa-6a82-4128-94fa-aa761dbdad13',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'abad51aa-6a82-4128-94fa-aa761dbdad13';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'abad51aa-6a82-4128-94fa-aa761dbdad13';
